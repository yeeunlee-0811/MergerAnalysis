function share = sharefn_two(theta,inp)
% sharefn_one generates total 4 shares givne parameters: og + two singletons + one bundle
% 1. parameter value changes (first TWO of thpk)
...
% product vars
nj0 = inp.nj0; % 4
pkmat = inp.pkmat; % nj0 (4) x npk
npk = inp.npk; % npk = 7
netflix = inp.netflix;
wavve = inp.wavve;
tving = inp.tving;
price = inp.price; % 2 x 1
